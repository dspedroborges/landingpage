    ...
    <>
      {
        ...
        <h2 className="text-2xl text-center my-4 text-white font-bold">Autenticação de usuário</h2>
        <form onSubmit={(e) => handleSubmit(e)} className="mx-auto border p-4 rounded-xl w-full lg:w-1/2 flex flex-col bg-white">
